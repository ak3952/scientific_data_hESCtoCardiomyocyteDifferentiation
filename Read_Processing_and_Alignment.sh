...
#Download Meso RNA-seq Data
#mkdir /media/storageA/hani/Apo_LUTI_Project/RNA_Meso_1_2
#cd /media/storageA/hani/Apo_LUTI_Project/RNA_Meso_1_2
#mkdir raw_fastq
#cd raw_fastq
#aws s3 sync s3://apo.mesorep.1and2.rnaseq.pairedend.data/JK13_fastqfiles/ ./
#sudo mkdir /mnt/Engram_Locker/fastq/hani/Apo_LUTI_Project/RNA_Meso_1_2
#sudo rsync -avh --progress --update --remove-source-files ./ /mnt/Engram_Locker/fastq/hani/Apo_LUTI_Project/RNA_Meso_1_2/
#ln -s /mnt/Engram_Locker/fastq/hani/Apo_LUTI_Project/RNA_Meso_1_2/* ./

#Download Meso Ribo-Seq: Replicate 1
#mkdir /media/storageA/hani/Apo_LUTI_Project/Ribo_Mesoderm_1
#mkdir /media/storageA/hani/Apo_LUTI_Project/Ribo_Mesoderm_1/raw_fastq
#cd /media/storageA/hani/Apo_LUTI_Project/Ribo_Mesoderm_1/raw_fastq
#aws s3 sync s3://apo.meso.rep2.riboseq.data/JK10_14_fastqfiles/ ./
#mv Mesoderm_Rep2_Riboseq_SampleInfo.xlsx ../
#sudo mkdir /mnt/Engram_Locker/fastq/hani/Apo_LUTI_Project/Ribo_Mesoderm_1
#sudo rsync -avh --progress --update --remove-source-files ./
#ln -s /mnt/Engram_Locker/fastq/hani/Apo_LUTI_Project/Ribo_Mesoderm_1/* ./

#Download Meso Ribo-Seq: Replicate 2
#mkdir /media/storageA/hani/Apo_LUTI_Project/Ribo_Mesoderm_2
#mkdir /media/storageA/hani/Apo_LUTI_Project/Ribo_Mesoderm_2/raw_fastq
#cd /media/storageA/hani/Apo_LUTI_Project/Ribo_Mesoderm_2/raw_fastq
#aws s3 sync s3://apo.meso.rep3.riboseq.data/JK11_15_fastqfiles/ ./
#mv Mesoderm_Rep3_Riboseq_SampleInfo.xlsx ../
#ln -s /mnt/Engram_Locker/fastq/hani/Apo_LUTI_Project/Ribo_Mesoderm_2/* ./

#Check that the files look ok on Engram & the links ok on storage A. Then Align everything!

#STAR RNA Alignment: Mesoderm
...
for i in ${array[@]}; do
  ...
  my_name=$(echo $i | grep -Po "(?<=raw_fastq/JK13_)BC[0-9]+(?=_R1.fastq.gz)")
...
for i in ${rna_bams[@]}; do
    ...
    featurecounts_1_4.py --run_mode rnaseq --transcript_annotations /media/storageA/hani/alignment/hg38_annotations/hg38_gencode_v32_codingonly.obj --transcript_format Obj --path_to_rnaseq $my_path"_R2only_q30.bam" --rnamapfactory fiveprime --nthreads 22 --outfile_prefix $my_path"_rnacounts"
    echo '...done!'
done
